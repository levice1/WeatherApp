...
class parseWeatherData(private val responceData: WeatherParse, private val binding: ActivityMainBinding, private val context:Context) {
    fun parse(){
        ...
        val txtTemp2DayId = (context as Activity).findViewById<TextView>(R.id.txt2DayTemperature)
        txtTemp2DayId.text = "$temp2Day°C"
        //3day
        val temp3Day = responceData.forecast.forecastday[2].day.avgtemp_c
        val txtTemp3DayId = (context as Activity).findViewById<TextView>(R.id.txt3DayTemperature)
        txtTemp3DayId.text = "$temp3Day°C"
        //4day
        val temp4Day = responceData.forecast.forecastday[3].day.avgtemp_c
        val txtTemp4DayId = (context as Activity).findViewById<TextView>(R.id.txt4DayTemperature)
        txtTemp4DayId.text = "$temp4Day°C"
        //5day
        val temp5Day = responceData.forecast.forecastday[4].day.avgtemp_c
        val txtTemp5DayId = (context as Activity).findViewById<TextView>(R.id.txt5DayTemperature)
        txtTemp5DayId.text = "$temp5Day°C"
        //6day
        val temp6Day = responceData.forecast.forecastday[5].day.avgtemp_c
        val txtTemp6DayId = (context as Activity).findViewById<TextView>(R.id.txt6DayTemperature)
        ...
        //2day
        val txtWeather2DayId = (context as Activity).findViewById<TextView>(R.id.txt2DayWeather)
        txtWeather2DayId.text = responceData.forecast.forecastday[1].day.condition.text
        //3day
        val txtWeather3DayId = (context as Activity).findViewById<TextView>(R.id.txt3DayWeather)
        txtWeather3DayId.text = responceData.forecast.forecastday[2].day.condition.text
        //4day
        val txtWeather4DayId = (context as Activity).findViewById<TextView>(R.id.txt4DayWeather)
        txtWeather4DayId.text = responceData.forecast.forecastday[3].day.condition.text
        //5day
        val txtWeather5DayId = (context as Activity).findViewById<TextView>(R.id.txt5DayWeather)
        txtWeather5DayId.text = responceData.forecast.forecastday[4].day.condition.text
        //6day
        val txtWeather6DayId = (context as Activity).findViewById<TextView>(R.id.txt6DayWeather)
        ...
        val txtDate2DayId = (context as Activity).findViewById<TextView>(R.id.txt2DayLabel)
        txtDate2DayId.text = "${date2Day[2]}-${date2Day[1]}"
        //3day
        val date3Day = responceData.forecast.forecastday[2].date.split("-")
        val txtDate3DayId = (context as Activity).findViewById<TextView>(R.id.txt3DayLabel)
        txtDate3DayId.text = "${date3Day[2]}-${date3Day[1]}"
        //4day
        val date4Day = responceData.forecast.forecastday[3].date.split("-")
        val txtDate4DayId = (context as Activity).findViewById<TextView>(R.id.txt4DayLabel)
        txtDate4DayId.text = "${date4Day[2]}-${date4Day[1]}"
        //5day
        val date5Day = responceData.forecast.forecastday[4].date.split("-")
        val txtDate5DayId = (context as Activity).findViewById<TextView>(R.id.txt5DayLabel)
